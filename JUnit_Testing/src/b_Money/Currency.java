...
//		Here we are first converting Currency to universal value and that universal value to currency we want
		Integer value = (int) ((int) othercurrency.universalValue(amount)/rate); 
		return value;
	}
}
