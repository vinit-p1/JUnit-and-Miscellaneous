...
//		In return we are dividing int value by 100 to separate decimal and then adding decimals in string using % function
...
//		Explicitly downcasting the Object.
		Money omoney =  (Money) other;
//		Using the reference of Money to compare
		return amount- currency.valueInThisCurrency(omoney.amount, omoney.currency);
	}
}